...
function convertHtmlToJson() {
  ...
  for (var i = 0; i < h1Elements.length; i++) {
      ...
      if (h1.textContent.includes("?")) {
        if (nextElem.tagName === "OL" || nextElem.tagName === "UL") {
            ...
            for (var j = 0; j < liElements.length; j++) {
                ...
                let option = {
                    text: li.textContent,
                    _shouldBeSelected: li.innerHTML.includes("<strong>") ? true : false,
            ...
            feedback.correct = '<p><strong>' + "That's right!" + '</p></strong>' + feedbackSplit[1]
            feedback._incorrect = {
                notFinal: '<p><strong>' + "Are you sure about that?" + '</p></strong>' + feedbackSplit[1],
                final: '<p><strong>' + "Are you sure about that?" + '</p></strong>' + feedbackSplit[1]
            };
        }
      }
    ...
    var blockObj = {
      ...
      displayTitle: h1.textContent.length > 5 ? "" : h1.textContent,
      body: "",
      _classes: "",
      _trackingId: i + 1,
      instruction: "",
